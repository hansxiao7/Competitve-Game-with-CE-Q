...
# q.update_Q()
#
# # print(q.pi_AB[0, 2, 0, 1, 1, :])
# # print(q.Q_A[0, 2, 0, 1, 1, :, :])
# # print(q.Q_B[0, 2, 0, 1, 1, :, :])
# # print(q.Q_A[0, 2, 0, 1, 1, 1, 4])
# print(q.Q_A[0, 2, 0, 1, 1, :])
# print(q.Q_B[0, 2, 0, 1, 1, :])
# print(q.Q_A[0, 2, 0, 1, 1, 1])
#
# import matplotlib.pyplot as plt
# plt.ylim(0, 0.5)
# plt.plot(range(len(q.error_A_list)), q.error_A_list)
#
# # from google.colab import drive
# # drive.mount('/content/drive')
# # np.savetxt('/content/drive/MyDrive/CS7642/P3/Q_learning_Q_A', q.Q_A)
# # np.savetxt('/content/drive/MyDrive/CS7642/P3/Q_learning_Q_B', q.Q_B)
# np.savetxt('/content/drive/MyDrive/CS7642/P3/Q_learning_Errors', q.error_A_list)
#
# q2 = Multi_Q('friend-Q')
# q2.update_Q()
#
# print(q2.Q_A[0, 2, 0, 1, 1, :, :])
# print(q2.Q_B[0, 2, 0, 1, 1, :, :])
# plt.ylim(0, 0.5)
# plt.plot(range(len(q2.error_A_list)), q2.error_A_list)
#
# np.savetxt('/content/drive/MyDrive/CS7642/P3/friend_Q_Q_A.txt', q2.Q_A[0, 2, 0, 1, 1, :, :])
# np.savetxt('/content/drive/MyDrive/CS7642/P3/friend_Q_Q_B.txt', q2.Q_B[0, 2, 0, 1, 1, :, :])
# np.savetxt('/content/drive/MyDrive/CS7642/P3/friend_Q_Errors.txt', q2.error_A_list)
#
# q3 = Multi_Q('ce-Q')
# q3.update_Q()
#
# plt.ylim(0, 0.5)
# plt.plot(range(len(q3.error_A_list)), q3.error_A_list)
#
# np.savetxt('/content/drive/MyDrive/CS7642/P3/ce_Q_Q_A.txt', q3.Q_A[0, 2, 0, 1, 1, :, :])
# np.savetxt('/content/drive/MyDrive/CS7642/P3/ce_Q_Q_B.txt', q3.Q_B[0, 2, 0, 1, 1, :, :])
# np.savetxt('/content/drive/MyDrive/CS7642/P3/ce_Q_Errors.txt', q3.error_A_list)
#
# print(q3.Q_A[0, 2, 0, 1, 1, :, :])
# print(q3.Q_B[0, 2, 0, 1, 1, :, :])
# print(q3.pi_AB[0, 2, 0, 1, 1, :])
